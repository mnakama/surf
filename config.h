...
static char bookmarkfile[]  = "~/.local/share/surf/bookmarks";

void bookmarkUrl(Client *c, const Arg *a);
void showBookmarks(Client *c, const Arg *a);
...
static SiteSpecific styles[] = {
	...
	{ ".*clubhouse\\.io.*",   "clubhouse-dark.css" },
};
...
static Key keys[] = {
	...
	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_b,      toggle,     { .i = JavaScript } },
	...
	{ MODKEY,                GDK_KEY_m,      bookmarkUrl, { 0 } },
	{ MODKEY,                GDK_KEY_z,      showBookmarks, { 0 } },
};
...
static SearchEngine searchengines[] = {
	...
	{ "s",   "https://startpage.com/do/search?language=english&cat=web&query=%s" },
